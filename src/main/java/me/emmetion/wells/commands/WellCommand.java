...
//    private final ValhallaMMO mmo = ValhallaMMO.getPlugin();
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        player.sendMessage("You are a part of town: " + town.getName());
...
//            try {
//                String townname = args[1]; // Town name to apply to
//                String buff_id = args[2].toUpperCase(); // BuffType string
...
//                    }
//                    case NONE -> player.sendMessage("Cannot put buff_id 'NONE' onto well!");
...
//                            return true;
//                        }
//                        creatureManager.spawnCreature(new PixieFactory(), well, null);
//                    }
//                    case SPAWN_NPC ->
//                            creatureManager.spawnCreature(new SpawnNPCFactory(creatureManager), null, Configuration.getInstance().getSpawnNPCLocation());
//                }
//            } catch (ArrayIndexOutOfBoundsException e) {
//                player.sendMessage("Syntax: /wells spawn <creature_type> [town_name]");
//            } catch (IllegalArgumentException e) {
//                player.sendMessage("Invalid creature type!");
//            }
