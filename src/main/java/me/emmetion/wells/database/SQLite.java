...
public class SQLite extends Database {
    ...
    String dbName;
    public SQLite(Wells instance) {
        super(instance);
        dbName = plugin.getConfig().getString("SQLite.Filename", "wells");
    }

    public String SQLiteCreateTokensTable = "CREATE TABLE IF NOT EXISTS wells (" + // make sure to put your table name in here too.
